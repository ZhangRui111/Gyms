...
class Actor(object):
    ...
    def add_grad_to_graph(self, a_grads):
        with tf.variable_scope('policy_grads'):
            ...
            # -----------------------------------
            # tf.gradient() https: // www.tensorflow.org / api_docs / python / tf / gradients
            # -----------------------------------
...
actor = Actor(sess, action_dim, action_bound_high, LR_A, REPLACEMENT)
...
if OUTPUT_GRAPH:
    tf.summary.FileWriter("logs/old/", sess.graph)
...
for i in range(MAX_EPISODES):
    ...
    for j in range(MAX_EP_STEPS):
        ...
        a = np.clip(np.random.normal(a, var), action_bound_low, action_bound_high)
...
if __name__ == '__main__':
    print('It still need re-organisation.')
