...
def build_network(n_features, n_actions, lr):
    ...
    with tf.variable_scope('eval_net'):
        e1 = tf.layers.dense(eval_net_input, 20, tf.nn.relu, kernel_initializer=w_initializer,
    ...
    with tf.variable_scope('target_net'):
        t1 = tf.layers.dense(target_net_input, 20, tf.nn.relu, kernel_initializer=w_initializer,
